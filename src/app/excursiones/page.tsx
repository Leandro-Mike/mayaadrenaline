...
export default async function ExcursionesPage() {
    ...
    const heroImage = settings.experiencias_hero_image || `${process.env.NEXT_PUBLIC_API_URL}/wp-content/uploads/2026/02/tulum4-scaled.webp`;
                    ...
                    <div className="bg-ma-verde-fondo text-white py-12">
                        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-8">
                            ...
                            <div className="flex flex-wrap justify-center md:justify-end gap-6">
                                {categories.length > 0 ? (
                                    categories.map((cat) => (
                                        <Link key={cat.id} href={`/excursiones/categoria/${cat.slug}`} className="group flex flex-col items-center">
